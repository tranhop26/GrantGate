...
Public-proof performance candidate: [`785c951`](https://github.com/tranhop26/GrantGate/commit/785c951) (verified locally; production deployment evidence is recorded after release)
...
| Performance candidate | Route-level lazy loading plus separate React, query, GenLayer, Viem, and cryptography chunks; largest minified chunk `254.18 kB` (`74.21 kB` gzip), down from the prior monolithic app chunk of about `775.9 kB` |
